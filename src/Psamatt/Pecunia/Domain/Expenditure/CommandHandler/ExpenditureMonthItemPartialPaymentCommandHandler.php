 ...
 */
class ExpenditureMonthItemPartialPaymentCommandHandler implements \ServiceBus\ICommandHandler
{
    ...
    public function handle(\ServiceBus\ICommand $command)
    {
        ...
        $calendarMonthExpenditure->addPartialPayment($command->itemId, $command->amount);
